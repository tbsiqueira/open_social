...
class FieldManager implements EntityFieldManagerInterface {
  ...
  public static function isOptedOutOfFieldAccessManagement(FieldDefinitionInterface $field_definition) : bool {
    return !$field_definition instanceof FieldConfigInterface || !static::getFieldStorageDefinition($field_definition)->getThirdPartySetting('social_profile', 'managed_access', TRUE);
  }
  ...
  public static function getManagedValueFieldName(FieldDefinitionInterface $field_definition) : ?string {
    ...
    return static::getFieldStorageDefinition($field_definition)->getThirdPartySetting('social_profile', 'visibility_for');
  }
  ...
  public static function getVisibilityFieldName(FieldDefinitionInterface $field_definition) : ?string {
    ...
    return static::getFieldStorageDefinition($field_definition)->getThirdPartySetting('social_profile', 'visibility_stored_by');
  }
